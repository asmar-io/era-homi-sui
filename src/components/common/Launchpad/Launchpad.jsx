...
export default function Launchpad() {
  ...
  const loadNFT = async () => {
    const object = await provider.getObject({
      id:SMART_CONTRACTS.NFT_COLLECTION_ADDRESS, options: { showDisplay: true, showContent: true }
    }).catch((e)=>e);
    console.log(object);
  ...
  return (
    <div>
      <h1  className="mt-12 text-center text-6xl font-bold uppercase">ERA HOMI</h1>
      <h3  className="mt-4 text-center text-base font-medium">
        Explore the most outstanding NTF Marketplace on Sui
      </h3>
     <div className="mt-12 justify-center items-center flex flex-col sm:flex-row gap-12">
    
      <div className="w-full ml-12">
        <Image
           src="https://cdn.discordapp.com/attachments/1049090805710729337/1109586234952650792/20230520_225625.gif"
           loader={() => "https://cdn.discordapp.com/attachments/1049090805710729337/1109586234952650792/20230520_225625.gif"}
          width={500}
          height={500}
      ...
      <div className="w-full">
        ...
        <Tabs className="mt-12">
          ...
          <button onClick={mint}  className="btn mt-12 min-w-[247px]">Mint</button>
          </TabPanel>
          <TabPanel>
          <br/>
          <p className='font-bold'>Mint Price: 5 SUI</p>
           ...
           <button onClick={whitelist_mint}  className="btn mt-12 min-w-[247px]">Whitelist Mint</button>
          </TabPanel>
          <TabPanel>
          <br/>
          <p className='font-bold'>Mint Price: 0 SUI</p>
           ...
           <button onClick={freemint_mint}  className="btn mt-12 min-w-[247px]">FreeMint</button>
          </TabPanel>
        </Tabs>
        <br/>
